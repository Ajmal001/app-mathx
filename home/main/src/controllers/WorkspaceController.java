...
//        System.out.println(questions);
        ...
        String question = "\n1. Two wires are 12m and 16m long. The wires are to be cut into pieces of equal length. Find the maximum length of each piece.<HINT: :HINT> <SEP>" +
                "\n 2. If you use 4 wires of the resultant length, what will be the area of shape formed? <HINT: :HINT>" +
